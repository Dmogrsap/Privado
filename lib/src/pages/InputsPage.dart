...
class _InputsPageState extends State<InputsPage> {
  ...
  //Control necesario para manipular el Input
  ...
  Widget _inputElements(BuildContext context) => ListView(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            ...
            onPressed: () {
              final snackBar = SnackBar(content: Text('Guardando datos'));
        ...
        children: <Widget>[
          ...
          Expanded(
              child: DropdownButton(
                  // es lo que va contener la lista desplegable
                  items: _opciones(),
                  value: _civil,
                  onChanged: (opcion) {
                    setState(() {
  ...
  Widget _showData() => ListTile(
        title: Text('Name: $_name\nCorreo: $_email\nPassword: $_password estado $_civil'),
      );

  String _civil = 'Soltero(a)'; // una variable para usar en el dropField
